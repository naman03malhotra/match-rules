...
export const NO_ARRAY_ERROR =
  "Rules shouldn't have an array, if your source contains array, please write a corresponding function in the rules";
export const NO_RULES_PRESENT =
  "No rules are present in the passed rule object";
